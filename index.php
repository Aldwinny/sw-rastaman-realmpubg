...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg">
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <?php
            # if the user is login, present them a way to logout.
            echo '<a href="/pages/login.php" class="nav-link"
    ...
    <header>
      <div class="head-card">
        <img
          src="/assets/floaters/img_pubgguy.png"
          class="head-card-img"
          alt="Person with gun"
        />
        <div>
      ...
      <div class="marketplace" id="shop">
        ...
        >
          <a href="/pages/item.php" onclick="setContext('head')">
            <figure
              title="From stylish caps to sturdy helmets. We have the highest quality available"
            >
              <figcaption>Head</figcaption>
              <img
                src="/assets/items/head_milihead.png"
                class="img-fluid"
                alt="Police cap"
              />
            </figure>
