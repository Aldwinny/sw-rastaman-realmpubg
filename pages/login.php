...
<body>
  ...
  <content>
    <div class="login">
      <form name="login" action="login.php" class="d-flex flex-column align-items-center justify-content-center" method="post">
        <img src="/assets/icon/icon+name.png" class="img-fluid" />
        <?php

        if (empty($_POST["email"]) or empty($_POST["password"])) {
          echo '<label>Login:</label><input name="email" type="text" placeholder="Enter email" /><label>Password: </label><input name="password" type="password" placeholder="Enter password" />';
          die();
        }
        ...
        if (!filter_var($email, FILTER_VALIDATE_EMAIL) or !checkdnsrr($domain, 'MX')) {
          ...
          echo '<label>Login:</label><input name="email" type="text" placeholder="Enter email" /><span style="color:red;">*</span><label>Password: </label><input name="password" type="password" placeholder="Enter password" />';
        } else {
        }
        ?>
        <br>
