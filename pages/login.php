...
<body>
    ...
    <main>
        <div class="login">
            <form action="login.php" class="d-flex flex-column align-items-center" method="POST">
                ...
                <div class="form-group">
                    <label>First name:</label><input name="fname" class="form-control" type="text"
                        placeholder="Enter first name" />
                    <label>Last name:</label><input name="lname" class="form-control" type="text"
                        placeholder="Enter last name" />
                </div>
                <div class="form-group">
                    <label>Email Address:</label><input name="email" class="form-control" type="email"
                        placeholder="Enter Email Address" />
                    <label>Contact:</label><input name="contact" class="form-control" type="contact"
                        placeholder="Enter Contact" />
                    <label>Address:</label><input name="address" class="form-control" type="address"
                        placeholder="Enter Address" />
                </div>
                <div class="form-group">
                    <label>Password:</label><br><input name="password" class="form-control" type="password"
    ...
    if (isset($_POST['fname'], $_POST['lname'], $_POST['email'], $_POST['contact'], $_POST['address'], $_POST['password'])) {
        ...
        echo "Register: $fname $lname $email $contact $address $pass";
